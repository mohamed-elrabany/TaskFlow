...
export default function TaskCard({ id, title, description, priority, status, dueDate, onDelete }) {
  return (
    <div className="bg-white border-2 border-gray-300 flex flex-col gap-4 rounded-lg p-8">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2 justify-center items-center">
          <button className="cursor-pointer p-2 text-center rounded-md hover:bg-gray-300">
            <FiEdit className="text-gray-700" />
          </button>
          <button onClick={onDelete} className="cursor-pointer p-2 text-center rounded-md hover:bg-red-100">
      ...
      <div className="flex gap-2 justify-start items-center text-gray-500">
        ...
        <span>{dueDate ? new Date(dueDate).toLocaleDateString('en-US', { month: 'short', day: '2-digit', year: 'numeric' }) : 'No due date'}</span>
      </div>
